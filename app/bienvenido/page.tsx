...
export default function BienvenidoPage() {
    const videoUrl = "/videos/hola-soy-maya.mp4"
            ...
            <div className="w-full max-w-6xl relative">
                ...
                <div className="relative flex flex-col lg:flex-row items-center gap-8 sm:gap-10 lg:gap-[54px]">
                    <div className="flex-1 flex flex-col items-start justify-center gap-4 w-full lg:w-auto">
                        <b className="self-stretch relative tracking-[-1.5px] leading-[50px] lg:leading-[60px] text-[42px] sm:text-[36px] lg:text-[42px] font-bold">Bienvenido a Plinng</b>
                ...
                <div className="flex lg:hidden mt-8 mb-[80px]">
                    <Link href="/descarga-app" className="w-full">
